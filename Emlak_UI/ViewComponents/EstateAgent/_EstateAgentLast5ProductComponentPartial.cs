...
using Emlak_UI.Dtos.EstateAgentDtos;
using Emlak_UI.Dtos.ProductDtos;
using Emlak_UI.Services;

namespace Emlak_UI.ViewComponents.EstateAgent
{
    public class _EstateAgentLast5ProductComponentPartial : ViewComponent
    {
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            var responseMessage = await client.GetAsync("https://localhost:44382/api/EstateAgentLastProducts?id=" + id);
