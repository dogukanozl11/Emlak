using Emlak_UI.Dtos.EmployeeDtos;
...
namespace Emlak_UI.Controllers
{
    public class EmployeeController : Controller
    {
        ...
        public async Task<IActionResult> CreateEmployee(CreateEmployeeDto createEmployeeDto)
        {
            ...
            var responseMassage = await client.PostAsync("https://localhost:44382/api/Employees ", stringContent);
        ...
        {
            var client = _httpClientFactory.CreateClient();
            var responseMessage = await client.DeleteAsync($"https://localhost:44382/api/Employees/{id}");
